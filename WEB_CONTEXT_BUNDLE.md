...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-58f801511958bc6f"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-58f801511958bc6f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-58f801511958bc6f",
        "url": "https://en.wikipedia.org/wiki/Agoh%E2%80%93Giuga_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Agoh–Giuga conjecture on the Bernoulli numbers that $p$ is prime if and only if $pB_{p-1}\\equiv -1{\\pmod {p}}$",
      "version": 1
    },
    "title": "Agoh–Giuga conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "a963b59fbf49855f680be3a07880360a6059f9ec5a4669ca99a582f7a26f88d5"
}
```
